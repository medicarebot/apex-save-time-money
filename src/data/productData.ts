...
export const productData: Record<string, ProductInfo> = {
  ...
  "operational-automation": {
    ...
    subtext: "APEX structures internal coordination into controlled workflows — routing tasks, enforcing escalation paths, and logging outcomes — so execution stays predictable across teams without adding management overhead.",
    heroExtra: "Deploy quickly. Operate with control.",
