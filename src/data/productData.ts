...
export const productData: Record<string, ProductInfo> = {
  ...
  "revenue-capture": {
    ...
    capabilities: [
      ...
      { title: "Calendar Coordination", description: "Synchronize availability and prevent conflicts across resources." },
    ...
    securityPosture: {
      ...
      points: [
        ...
        "Secure integration approach for connected channels and calendar systems",
        "Retention and deletion controls (based on client configuration)",
      ],
    },
    architectureFlow: {
      input: "Booking Requests, Availability, Client Messages",
